...
from config.paths import KL8_HISTORY_FILE, KILL_LOGS, KILL_REPORT, OUTPUT_DIR
...
from core.number_feed_review import write_number_feed_reports
...
def run_diagnose() -> None:
    ...
    checks = {
        ...
        "core.similarity_matcher": True,
        "core.density_detector": True,
        "core.pattern_recognizer": True,
        "core.curve_analyzer": True,
        "core.markov_engine": True,
        "core.kill_predictor": True,
        "core.cross_feed": True,
    }
